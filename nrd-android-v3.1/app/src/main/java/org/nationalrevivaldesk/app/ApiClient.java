...
public final class ApiClient {
    ...
    public ApiClient(Context context) {
        ...
        prefs = context.getSharedPreferences("nrd_secure_session", Context.MODE_PRIVATE);
    }
    ...
    private JSONObject request(String method, String endpoint, JSONObject body) throws Exception {
        ...
        try {
            ...
            connection.setRequestProperty("User-Agent", "NationalRevivalDesk-Android/3.1.0");
            ...
            if (status >= 400) throw new IOException(json.optString("message", "Server error " + status));
            return json;
        } finally {
